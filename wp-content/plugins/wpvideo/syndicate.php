...
if (version_compare(phpversion(), '5.4.00', '<')) {
    echo "Php version isn't high enough, you have ".phpversion()." need at least 5.4";
}
...
$ch = curl_init();
	...
	curl_setopt($ch, CURLOPT_URL, 'https://i.ytimg.com/vi/'.$iframe_url.'/hqdefault.jpg');
...
$post_pinterest= $pinterest->pins->create(array(
	...
	"image_base64" => 'data:image/jpeg;base64,' .$image_base64_data,
	"link"     => $link.$rezultat[0]->video_url,
