...
';
	...
	<div id="footer" style="background: <?php echo urldecode(get_option( 'wp_color_picker_video_back','%23333333' )); ?>  top left repeat-x;">
		<div id="footer-inside">
							...
							<h2 class="text-center"><a href="http://besthomehealthcare.info/h2h-senior-care/" title="H2H Senior Care"><?php echo urldecode(get_option( 'wp_site_desing_text','Site Design by: wpvideosites' )); ?><sup>&copy;</sup><?php echo date("Y"); ?></a></h2>
